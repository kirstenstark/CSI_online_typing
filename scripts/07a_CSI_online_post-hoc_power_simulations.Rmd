---
title: "07a CSI online additional analyses: Post-hoc power"
...
```{r load_packages,results="hide", cache = TRUE}
library(dplyr)
library(tidyr)
library(devtools)
library(MASS)
...
```{r PowerSim_m2_verbal_30,results="hide", cache = TRUE}
(Power_m2_verbal_30 <- powerSim(m_verbal, 
...
```{r Power_m2_verbal_30_save_for_export}
results <- summary(Power_m2_verbal_30)
Power_m2_verbal_30$warnings
Power_m2_verbal_30$errors
...
simr_results <- as.data.frame(cbind(rep("verbal_s30_t_around109", 
              ...
              rep(nrow(Power_m2_verbal_30$warnings), 
                  times =Power_m2_verbal_30$n)))
colnames(simr_results)<-c("name", "nsubjects", "ntrials", "ncat",
                          "pval",
                          "successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_24,results="hide", cache = TRUE}
...
results_df <- as.data.frame(cbind(rep("verbal_s24_t_around109", 
              ...
              rep(nrow(pc_verbal24$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_20,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_16,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_10,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_8,results="hide", cache = TRUE}
...
*6 participants, 120 trials:*


```{r PowerCurve_m2_verbal_6,results="hide", cache = TRUE}
(pc_verbal6 <- powerCurve(m_verbal, test=fixed("Pos.cont", method = "t"),
                           along = "subject", breaks = c(6), nsim = 1000))
...
```{r PowerCurve_m2_verbal_6_results}
#plot(pc_verbal5)
summary(pc_verbal6)
pc_verbal6$warnings
pc_verbal6$errors
...
```{r PowerCurve_m2_verbal_6_add_to_df}
results <- summary(pc_verbal6)
results_df <- as.data.frame(cbind(rep("verbal_s6_t_around109", 
                                        times= results$trials), 
                                    rep(6, times = results$trials),
                                    rep(72, times = results$trials),
                                  rep(24, times = results$trials),
              pc_verbal6[["ps"]][[1]]$pval, 
              rep(results$successes, times = results$trials),
              rep(results$mean,  times = results$trials),
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal6$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 

```{r PowerCurve_m2_verbal_6_export}
simr_results <- rbind(simr_results, results_df)
write.csv(simr_results, here::here("results", "power_sim",  "posthoc_powersim.csv"))
```
...
```{r PowerCurve_m2_verbal_cat19,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat19_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat19", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_19$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_cat16,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat16_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat16", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_16$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_cat13,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat13_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat13", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_13$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_cat8,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat8_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat8", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_8$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_cat6,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat6_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat6", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_6$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_verbal_cat4,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_verbal_cat4_summary}
...
results_df <- as.data.frame(cbind(rep("verbal_s30_cat4", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_verbal_categories_4$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerSim_m2_typing_30,results="hide", cache = TRUE}
...
results_df <- as.data.frame(cbind(rep("typing_s30_t_around109", 
                                    ...
                                    rep(109, times = results$trials),
                                    rep(24, times = results$trials),
                Power_m2_typing_30[["pval"]], 
              rep(results$successes, times = results$trials),
              rep(results$mean,  times = results$trials),
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(Power_m2_typing_30$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_typing_24,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_20,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_16,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_16_summary}
#plot(pc_typing16)
summary(pc_typing16)
...
```{r PowerCurve_m2_typing_10,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_10_summary}
#plot(pc_typing10)
summary(pc_typing10)
...
```{r PowerCurve_m2_typing_8,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_8_summary}
#plot(pc_typing8)
summary(pc_typing8)
pc_typing8$warnings
pc_typing8$errors
...
```{r PowerCurve_m2_typing_6,results="hide", cache = TRUE}
(pc_typing6 <- powerCurve(m_typing, test=fixed("Pos.cont", method = "t"),
                           along = "subject", breaks = c(6), nsim = 1000))
saveRDS(pc_typing6, 
        file = here::here("results", "power_sim",
                          "pc_typing6.RDS"))
...
```{r PowerCurve_m2_typing_6_summary}
#plot(pc_typing6)
summary(pc_typing6)
pc_typing6$warnings
pc_typing6$errors
...
```{r PowerCurve_m2_typing_6_add_to_df}
results <- summary(pc_typing6)
results_df <- as.data.frame(cbind(rep("typing_s6_t_around109", 
                                        times= results$trials), 
                                    rep(6, times = results$trials),
                                    rep(18, times = results$trials),
                                  rep(24, times = results$trials),
              pc_typing6[["ps"]][[1]]$pval, 
              rep(results$successes, times = results$trials),
              rep(results$mean,  times = results$trials),
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing6$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 

```{r PowerCurve_m2_typing_6_export}
simr_results <- rbind(simr_results, results_df)
write.csv(simr_results, here::here("results", "power_sim",  "posthoc_powersim.csv"))
```
...
```{r PowerCurve_m2_typing_cat19,results="hide", cache = TRUE}
(pc_typing_categories_19 <- powerCurve(m_typing, test=fixed("Pos.cont", method = "t"),
                                       along = "category", breaks = c(19),
                                       nsim = 1000, seed = 99))
saveRDS(pc_typing_categories_19, 
        file = here::here("results", "power_sim",
                          "pc_typing_categories_19.RDS"))
```

```{r PowerCurve_m2_typing_cat19_summary}
#plot(pc_typing_categories_19)
summary(pc_typing_categories_19)
pc_typing_categories_19$warnings
pc_typing_categories_19$errors
```

```{r PowerCurve_m2_typing_cat19_add_to_df}
results <- summary(pc_typing_categories_19)
results_df <- as.data.frame(cbind(rep("typing_s30_cat19", 
                                        times= results$trials), 
                                    rep(30, times = results$trials),
                                    rep(86, times = results$trials),
                                    rep(19, times = results$trials),
              pc_typing_categories_19[["ps"]][[1]]$pval, 
              rep(results$successes, times = results$trials),
              rep(results$mean,  times = results$trials),
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing_categories_19$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 

```{r PowerCurve_m2_typing_cat19_export}
simr_results <- rbind(simr_results, results_df)
write.csv(simr_results, here::here("results", "power_sim",  "posthoc_powersim.csv"))
```
...
```{r PowerCurve_m2_typing_cat16,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_cat16_summary}
...
results_df <- as.data.frame(cbind(rep("typing_s30_cat16", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing_categories_16$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_typing_cat13,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_cat13_summary}
...
results_df <- as.data.frame(cbind(rep("typing_s30_cat13", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing_categories_13$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_typing_cat8,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_cat8_summary}
...
results_df <- as.data.frame(cbind(rep("typing_s30_cat8", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing_categories_8$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_typing_cat6,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_cat6_summary}
...
results_df <- as.data.frame(cbind(rep("typing_s30_cat6", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
              rep(nrow(pc_typing_categories_6$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
...
```{r PowerCurve_m2_typing_cat4,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_cat4_summary}
...
results_df <- as.data.frame(cbind(rep("typing_s30_cat4", 
              ...
              rep(results$lower,  times = results$trials),
              rep(results$upper,  times = results$trials),
               rep(nrow(pc_typing_categories_4$warnings), 
                  times = results$trials)))
colnames(results_df)<-c("name", "nsubjects", "ntrials", "ncat",
                        "pval","successes", "mean", "lower", "upper", "warnings")
``` 
