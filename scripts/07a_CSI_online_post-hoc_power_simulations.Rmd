...
```{r PowerCurve_m2_verbal_5,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_5,results="hide", cache = TRUE}
...
```{r PowerCurve_m2_typing_5_summary}
#plot(pc_typing5)
summary(pc_typing5)
pc_typing5$warnings
pc_typing5$errors
